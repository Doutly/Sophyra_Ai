...
export default function Footer() {
  ...
  const openPopup = (key: PopupKey) => setActivePopup(key);
  const closePopup = () => setActivePopup(null);

  return (
    <>
      <footer className="bg-[#030712] pt-16 pb-10 px-6 sm:px-8 lg:px-12">
        <div className="max-w-6xl mx-auto">

          <div className="relative bg-white rounded-3xl px-8 py-10 mt-6">
            <div className="hidden md:block absolute -top-5 -left-4 w-[80px] h-[60px] scale-75 origin-top-left">
              <TapeSVG />
            </div>
            <div className="hidden md:block absolute -top-5 -right-4 w-[80px] h-[60px] scale-75 origin-top-right rotate-90">
              <TapeSVG />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
              <div className="lg:col-span-2 space-y-5">
                <div className="flex items-center gap-3">
                  <img src="/lo.png" alt="Sophyra AI" className="w-9 h-9 object-contain" />
                  <span className="text-xl font-bold text-slate-900">Sophyra AI</span>
                </div>
                <p className="text-sm text-slate-500 leading-relaxed max-w-xs">
                  Sophyra decides before the interviewer does. Practice with AI that thinks like a recruiter and get Big-Tech grade feedback on every session.
                </p>

                <div className="space-y-2">
                  <div className="flex items-center gap-2 text-sm text-slate-500">
                    <Phone className="w-3.5 h-3.5 text-slate-400 flex-shrink-0" />
                    <span>+91 90199 11866</span>
                  </div>
                  <div className="flex items-center gap-2 text-sm text-slate-500">
                    <Phone className="w-3.5 h-3.5 text-slate-400 flex-shrink-0" />
                    <span>+91 80888 87775</span>
                  </div>
                  <div className="flex items-center gap-2 text-sm text-slate-500">
                    <Mail className="w-3.5 h-3.5 text-slate-400 flex-shrink-0" />
                    <span>contact@sophyra.ai</span>
                  </div>
                  <div className="flex items-center gap-2 text-sm text-slate-500">
                ...
                <div className="flex items-center gap-3 pt-1">
                  <a
                    href="https://www.linkedin.com/company/sophyra-aii/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-9 h-9 bg-slate-100 rounded-xl flex items-center justify-center hover:bg-slate-200 transition-colors text-slate-600 hover:text-slate-900"
                    aria-label="LinkedIn"
                  >
                    <Linkedin className="w-4 h-4" />
                  </a>
                  <a
                    href="https://www.instagram.com/sophyra.ai?igsh=NGp3bGZoejVmZ2Jr&utm_source=qr"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-9 h-9 bg-slate-100 rounded-xl flex items-center justify-center hover:bg-slate-200 transition-colors text-slate-600 hover:text-slate-900"
                  ...
                  <a
                    href="mailto:contact@sophyra.ai"
                    className="w-9 h-9 bg-slate-100 rounded-xl flex items-center justify-center hover:bg-slate-200 transition-colors text-slate-600 hover:text-slate-900"
                    aria-label="Email"
                  >
              ...
              <div>
                <h4 className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-5">Platform</h4>
                <ul className="space-y-3">
                  <li>
                    ...
                    >
                      <BookOpen className="w-3.5 h-3.5 text-slate-300 group-hover:text-slate-600 transition-colors" />
                      How It Works
                    </button>
                  </li>
                  <li>
                    <button
                      ...
                      className="flex items-center gap-2 text-sm text-slate-500 hover:text-slate-900 transition-colors group"
                    >
                      <DollarSign className="w-3.5 h-3.5 text-slate-300 group-hover:text-slate-600 transition-colors" />
                      Pricing
                    </button>
                  </li>
                  <li>
                    <button
                      ...
                      className="flex items-center gap-2 text-sm text-slate-500 hover:text-slate-900 transition-colors group"
                    >
                      <FileText className="w-3.5 h-3.5 text-slate-300 group-hover:text-slate-600 transition-colors" />
                      Reports
                    </button>
                  </li>
                  <li>
                    <button
                      onClick={() => openPopup('universities')}
                      className="flex items-center gap-2 text-sm text-slate-500 hover:text-slate-900 transition-colors group"
                    >
                      <Building2 className="w-3.5 h-3.5 text-slate-300 group-hover:text-slate-600 transition-colors" />
                      For Universities
                    </button>
                  </li>
                </ul>
              ...
              <div>
                <h4 className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-5">Company</h4>
                <ul className="space-y-3">
                  <li>
                    <button
                      ...
                      className="flex items-center gap-2 text-sm text-slate-500 hover:text-slate-900 transition-colors group"
                    >
                      <Info className="w-3.5 h-3.5 text-slate-300 group-hover:text-slate-600 transition-colors" />
                      About
                    </button>
                  </li>
                  <li>
                  ...
                  <li>
                    <button
                      ...
                      className="flex items-center gap-2 text-sm text-slate-500 hover:text-slate-900 transition-colors group"
                    >
                      <MessageSquare className="w-3.5 h-3.5 text-slate-300 group-hover:text-slate-600 transition-colors" />
                      Contact
                    </button>
                  </li>
                  <li>
              ...
              <div>
                <h4 className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-5">Legal</h4>
                <ul className="space-y-3">
                  <li>
                    <button
                      ...
                      className="flex items-center gap-2 text-sm text-slate-500 hover:text-slate-900 transition-colors group"
                    >
                      <Shield className="w-3.5 h-3.5 text-slate-300 group-hover:text-slate-600 transition-colors" />
                      Privacy Policy
                    </button>
                  </li>
                  <li>
                  ...
                  <li>
                    <button
                      ...
                      className="flex items-center gap-2 text-sm text-slate-500 hover:text-slate-900 transition-colors group"
                    >
                      <Lock className="w-3.5 h-3.5 text-slate-300 group-hover:text-slate-600 transition-colors" />
                      Data Security
                    </button>
                  </li>
                  <li>
                    <button
                      ...
                      className="flex items-center gap-2 text-sm text-slate-500 hover:text-slate-900 transition-colors group"
                    >
                      <Cookie className="w-3.5 h-3.5 text-slate-300 group-hover:text-slate-600 transition-colors" />
                      Cookie Policy
                    </button>
                  </li>
                </ul>
          ...
          <div className="mt-6 flex flex-col sm:flex-row items-center justify-between gap-4 px-1">
            <p className="text-xs text-white/30">© {currentYear} Sophyra AI. All rights reserved.</p>
            <div className="flex items-center gap-3">
              <span className="text-xs text-white/20">Provided by</span>
              <a
      ...
      <FooterPopup isOpen={activePopup === 'universities'} onClose={closePopup} title="Partner with Us — For Universities" size="lg">
        <UniversityContactForm />
      </FooterPopup>

      <FooterPopup isOpen={activePopup === 'reports'} onClose={closePopup} title="Sophyra Reports">
        <div className="px-6 py-6 space-y-4">
          <div className="flex items-center gap-3 p-4 bg-blue-50 rounded-xl">
            <FileText className="w-8 h-8 text-blue-500 flex-shrink-0" />
            <div>
              <p className="font-semibold text-slate-800 text-sm">AI-Powered Interview Reports</p>
              <p className="text-xs text-slate-500 mt-0.5">Detailed feedback on every session</p>
            </div>
          </div>
          <p className="text-sm text-slate-600 leading-relaxed">
            After every mock interview, Sophyra generates a comprehensive report covering communication skills, technical depth, confidence levels, body language analysis, and a personalized improvement roadmap.
          </p>
          <ul className="space-y-2">
            {['Section-wise scoring with benchmarks', 'Sentiment and tone analysis', 'Filler word frequency tracking', 'Compare across multiple sessions', 'Shareable PDF export'].map((item) => (
          ...
          <div className="p-3 bg-amber-50 border border-amber-100 rounded-lg">
            <p className="text-xs text-amber-700 font-medium">Full report dashboard coming soon. Currently available after each interview session.</p>
          </div>
        </div>
      </FooterPopup>

      <FooterPopup isOpen={activePopup === 'about'} onClose={closePopup} title="About Sophyra AI">
        <div className="px-6 py-6 space-y-4">
          <div className="w-12 h-12 bg-slate-100 rounded-xl flex items-center justify-center">
            <img src="/lo.png" alt="Sophyra AI" className="w-8 h-8 object-contain" />
          </div>
          <p className="text-sm text-slate-600 leading-relaxed">
            Sophyra AI is an intelligent mock interview platform built to help students and professionals land their dream jobs. We simulate real interview conditions with an AI interviewer that thinks like a top-tier recruiter — asking tough follow-ups, adapting in real time, and giving Big-Tech grade feedback.
          </p>
          <p className="text-sm text-slate-600 leading-relaxed">
            Our mission is to democratise interview preparation — making world-class coaching accessible to every candidate, not just those with expensive mentors or elite networks.
          </p>
          <div className="grid grid-cols-3 gap-3 pt-2">
            {[['10k+', 'Sessions'], ['500+', 'Universities'], ['98%', 'Satisfaction']].map(([num, label]) => (
      ...
      <FooterPopup isOpen={activePopup === 'contact'} onClose={closePopup} title="Contact Sophyra AI">
        <div className="px-6 py-6 space-y-4">
          {[
            { icon: Phone, label: 'Phone', values: ['+91 90199 11866', '+91 80888 87775'] },
            { icon: Mail, label: 'Email', values: ['contact@sophyra.ai'] },
            { icon: MapPin, label: 'Location', values: ['India'] },
            ...
            <div key={label} className="flex items-start gap-3 p-4 bg-slate-50 rounded-xl">
              ...
              <div>
                ...
                {values.map((v) => <p key={v} className="text-sm text-slate-700 mt-0.5">{v}</p>)}
              </div>
            </div>
          ))}
          <div className="flex gap-3 pt-2">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 flex items-center justify-center gap-2 py-2.5 bg-[#0077B5] text-white text-sm font-medium rounded-xl hover:bg-[#006399] transition-colors"
            >
              <Linkedin className="w-4 h-4" />
              LinkedIn
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 flex items-center justify-center gap-2 py-2.5 bg-gradient-to-r from-[#833ab4] via-[#fd1d1d] to-[#fcb045] text-white text-sm font-medium rounded-xl hover:opacity-90 transition-opacity"
            >
              <InstagramIcon />
              Instagram
            </a>
      ...
      <FooterPopup isOpen={activePopup === 'privacy'} onClose={closePopup} title="Privacy Policy">
        <div className="px-6 py-6 space-y-4">
          <p className="text-xs text-slate-400">Last updated: February 2026</p>
          {[
            { title: 'Information We Collect', text: 'We collect information you provide directly (name, email, resume data), usage data, and interview session data necessary to provide our services.' },
            { title: 'How We Use Your Data', text: 'Your data is used solely to provide the Sophyra AI interview service, generate feedback reports, and improve our AI models. We do not sell your personal data.' },
            { title: 'Data Storage', text: 'Data is stored securely using Firebase (Google Cloud). Interview recordings and reports are encrypted at rest and in transit.' },
            { title: 'Your Rights', text: 'You may request deletion of your data at any time by contacting contact@sophyra.ai. We will process requests within 30 days.' },
            { title: 'Contact', text: 'For privacy-related queries, reach us at contact@sophyra.ai or +91 90199 11866.' },
          ].map(({ title, text }) => (
            <div key={title}>
      ...
      <FooterPopup isOpen={activePopup === 'terms'} onClose={closePopup} title="Terms of Service">
        <div className="px-6 py-6 space-y-4">
          <p className="text-xs text-slate-400">Last updated: February 2026</p>
          {[
            { title: 'Acceptance', text: 'By using Sophyra AI, you agree to these Terms. If you do not agree, please do not use our platform.' },
            { title: 'Use of Service', text: 'Sophyra AI is intended for personal interview preparation. You may not use it for commercial redistribution or to train competing AI systems.' },
            { title: 'User Content', text: 'You retain ownership of your resume and responses. By uploading content, you grant us a limited license to process it for service delivery.' },
            { title: 'Prohibited Activities', text: 'Impersonation, scraping, or any attempt to reverse-engineer our AI models is strictly prohibited.' },
            { title: 'Termination', text: 'We reserve the right to terminate accounts that violate these terms. You may delete your account at any time.' },
          ].map(({ title, text }) => (
            <div key={title}>
              <p className="text-sm font-semibold text-slate-800 mb-1">{title}</p>
              <p className="text-sm text-slate-500 leading-relaxed">{text}</p>
      ...
      <FooterPopup isOpen={activePopup === 'security'} onClose={closePopup} title="Data Security">
        <div className="px-6 py-6 space-y-4">
          <div className="flex items-center gap-3 p-4 bg-green-50 border border-green-100 rounded-xl">
            <Lock className="w-6 h-6 text-green-600 flex-shrink-0" />
            <p className="text-sm text-green-800 font-medium">Your data is protected with industry-standard security measures.</p>
          </div>
          {[
            { title: 'Encryption', text: 'All data is encrypted in transit using TLS 1.3 and at rest using AES-256 encryption.' },
            { title: 'Access Control', text: 'Only authorized personnel can access user data. All access is logged and audited.' },
            { title: 'Infrastructure', text: 'We use Google Firebase / Cloud infrastructure, which meets SOC 2, ISO 27001, and GDPR standards.' },
            { title: 'Incident Response', text: 'In the event of a breach, affected users will be notified within 72 hours per regulatory requirements.' },
            { title: 'Report a Concern', text: 'Please email security@sophyra.ai to report any security concerns.' },
          ].map(({ title, text }) => (
            <div key={title}>
              <p className="text-sm font-semibold text-slate-800 mb-1">{title}</p>
              <p className="text-sm text-slate-500 leading-relaxed">{text}</p>
      ...
      <FooterPopup isOpen={activePopup === 'cookies'} onClose={closePopup} title="Cookie Policy">
        <div className="px-6 py-6 space-y-4">
          <p className="text-xs text-slate-400">Last updated: February 2026</p>
          {[
            { title: 'What Are Cookies', text: 'Cookies are small text files stored on your device to help websites function properly and improve user experience.' },
            { title: 'Cookies We Use', text: 'We use essential cookies (authentication, session), analytics cookies (Firebase Analytics), and performance cookies. We do not use advertising cookies.' },
            { title: 'Essential Cookies', text: 'These are required for the platform to function. They cannot be disabled. Examples include authentication tokens and session identifiers.' },
            { title: 'Analytics Cookies', text: 'We use Google Firebase Analytics to understand platform usage patterns. This data is anonymised and not linked to your personal identity.' },
            { title: 'Managing Cookies', text: 'You can control cookies through your browser settings. Disabling essential cookies may affect platform functionality.' },
          ].map(({ title, text }) => (
            <div key={title}>
              <p className="text-sm font-semibold text-slate-800 mb-1">{title}</p>
              <p className="text-sm text-slate-500 leading-relaxed">{text}</p>
