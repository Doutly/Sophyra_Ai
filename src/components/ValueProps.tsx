        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4 tracking-tight leading-[1.1]">
              ...
              <br />
              <span className="text-white/25">drives measurable improvement</span>
            </h2>
              ...
              <div className="bg-gradient-to-r from-amber-500/10 via-amber-400/5 to-transparent border-b border-white/5 px-6 py-4 flex items-center justify-between flex-shrink-0">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[9px] text-white/25">Sophyra AI — Interview Intelligence Report</p>
                  </div>
                </div>
              ...
              <div className="p-6 flex-1 overflow-auto">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <div className="flex items-center justify-between mb-5">
                      <div>
                        <p className="text-[9px] text-white/25 font-medium uppercase tracking-widest mb-1">Overall Score</p>
                        <div className="flex items-end gap-1">
                          <span className="text-4xl font-bold text-white">87</span>
                          <span className="text-base text-white/25 mb-0.5">/100</span>
                        </div>
                      </div>
                      <div className="text-right">
                        <p className="text-[9px] text-white/25 font-medium uppercase tracking-widest mb-1">Grade</p>
                  ...
                  <div className="space-y-4">
                    <div>
                      <p className="text-[9px] text-white/25 font-semibold uppercase tracking-widest mb-2.5">Key Strengths</p>
                    ...
                    <div>
                      <p className="text-[9px] text-white/25 font-semibold uppercase tracking-widest mb-2.5">Growth Areas</p>
                      <div className="space-y-1.5">
                ...
                <div className="mt-4 pt-4 border-t border-white/5 flex items-center justify-between">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[9px] text-white/20">Certified by Sophyra AI</span>
                  </div>
                  <div className="flex items-center gap-0.5">
                    {[...Array(5)].map((_, i) => <Star key={i} className="w-2.5 h-2.5 fill-amber-400 text-amber-400" />)}
                    <span className="text-[9px] text-white/20 ml-1">Big-Tech Grade</span>
                  </div>
                </div>
              </div>
            </div>
